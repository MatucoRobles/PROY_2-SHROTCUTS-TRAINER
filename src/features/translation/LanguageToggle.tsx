...
export function LanguageToggle() {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-16 z-50 inline-flex items-center justify-center gap-1 h-10 px-3 rounded-full bg-slate-800/80 light:bg-white/80 border border-slate-700 light:border-slate-300 text-slate-200 light:text-slate-700 hover:bg-slate-700 light:hover:bg-slate-100 transition-colors backdrop-blur-sm shadow-[0_2px_8px_rgba(0,0,0,0.3)] light:shadow-[0_2px_8px_rgba(0,0,0,0.08)] text-xs font-semibold"
    >
